	...
	render() {
		...
		if (mode === "Connect") {
			...
			app = (
				<div>
					<p>
						<button onClick={() => parent.doCreate()}>Create</button>
						<br />
						Create an event
					</p>
					<p>
						<button onClick={() => parent.doRSVP()}>RSVP</button>
						<br />
						RSVP for an event
					</p>
					<p>
						<button onClick={() => parent.doCheckin()}>Checkin</button>
						<br />
						Check-in at an event
					</p>
					<p>
						<button onClick={() => parent.doClose()}>Close</button>
						<br />
						Close an event
					</p>
				</div>
